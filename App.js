...
function App(props) {
  ...
  // if(props.bgm.src === "") props.setbgm("bgm1.mp3");
  ...
  if(root === 0) return (
      ...
      <Game setRoot={setRoot} lang={language} bgmsrc={props.bgmsrc} setbgm={props.setbgm} setbgmvol={props.setbgmvol} playsfx={props.playsfx} setsfxvol={props.setsfxvol}/>
  );
  else if(root === 2) return (
      <Settings setRoot={setRoot} lang={language} bgmsrc={props.bgmsrc} toggleLanguage={toggleLanguage} setbgm={props.setbgm} setbgmvol={props.setbgmvol} bgmvol={props.bgmvol} playsfx={props.playsfx} setsfxvol={props.setsfxvol} sfxvol={props.getsfxvol}/>
  );
}
